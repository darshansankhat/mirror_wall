...
import '../Provider_class/Browser_provider.dart';
...
class _Browser_screenState extends State<Browser_screen> {
  ...
  void initState() {
    ...
    pullToRefreshController = PullToRefreshController(onRefresh: () {
      Provider.of<Browser_provider>(context, listen: false)
          .webViewController!
          .reload();
    });
  }
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: IconButton(
                        onPressed: () {},
                        icon: Image.asset(
                          "assets/image/browser_img/l.png",
                          height: 50,
                          width: 50,
                          fit: BoxFit.fill,
                        )),
                    suffixIcon: IconButton(
                      onPressed: () {
                        providerT!.search=txtsearch.text;
                         providerT!.webViewController!.loadUrl(
                                urlRequest: URLRequest(
                                  url: Uri.parse(
                                      "https://www.google.com/search?q=${providerT!.search}"),
                                ),
                              );
                      },
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                  ...
                  icon: Image.asset("assets/image/browser_img/r.png",
